...
class UsersControllerTest {
    ...
    //take from hexlet git repository
    //https://github.com/hexlet-components/java-spring-blog/blob/main/src/test/java/io/hexlet/blog/controller/api/UsersControllerTest.java
    ...
    public void setUp() {
        ...
        token = jwt().jwt(builder -> builder.subject(testUser.getEmail())); //take from hexlet git repository
    }
    ...
    public void testCreate() throws Exception {
        ...
        var request = post("/users")
                .with(token) //take from hexlet git repository
