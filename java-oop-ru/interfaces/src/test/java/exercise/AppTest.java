...
class AppTest {
    ...
    public void reversedSequenceTest() {
        ...
        var expected3 = "dc";
        var expected4 = 'd';
        var actual1 = (new ReversedSequence("abcd")).toString();
        var actual2 = (new ReversedSequence("abcd")).length();
        var actual3 = (new ReversedSequence("abcd")).subSequence(0, 2).toString();
        var actual4 = (new ReversedSequence("abcd")).charAt(0);
